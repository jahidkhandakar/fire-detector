...
class DeviceAlertPage extends StatelessWidget {
  const DeviceAlertPage({super.key});
          ...
          Obx(() {
            ...
            if (deviceCtrl.error.isNotEmpty) {
              return Row(
                children: [
                  Expanded(
                    child: Text(deviceCtrl.error.value,
            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  // Show fire dialog if unresolved
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: Icon(
                        ...
                        color: a.status.toLowerCase() == 'resolved'
                            ? Colors.green
                            : Colors.red,
                      ),
                      title: Text(
  ...
  /// Popup when an unresolved alert is detected: lets user resolve immediately
  void _showFireDialog(
      BuildContext context, AlertController controller, AlertModel a) {
    showDialog(
      context: context,
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () async {
              await controller.resolveAlert(a.id); // calls /alerts/<id>/resolve/
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Center(
              child: Icon(Icons.info_outline,
                  color: Colors.deepOrangeAccent, size: 44),
            ),
            ...
            _row('Owner Phone', a.ownerPhone.isEmpty ? 'N/A' : a.ownerPhone),
